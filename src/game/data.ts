...
export const NOOK_QUESTS: {
...
}[] = [
  {
    ...
    hint: '树下可以找到树枝，摇树也会掉',
    turnIn: ['哦——！10根树枝都齐了喵！营火的燃料足够了！', '下一个目标发布在服务处了喵——去广场找向导皮卡丘，它会告诉你要做什么喵！'],
    rewardMiles: 500,
  },
  {
  ...
  },
  {
    ...
    hint: '去友好商店找喵喵对话',
    turnIn: ['想要在这座岛上生活，DIY可是基础中的基础喵！', '看好了——用捡来的树枝就能做出工具！这把「简陋钓竿」「简陋虫网」和「简陋斧头」就送给你喵！', '去钓一条鱼来给我看看吧——任务详情到服务处找皮卡丘确认喵！'],
    rewardMiles: 500, rewardText: '学会了DIY！获得了 鱼竿、虫网 和 斧头！',
  },
  {
    id: 'fish', title: '钓 1 条鱼给喵喵', need: 1,
    hint: '装备鱼竿对着河面按 E，浮漂下沉瞬间拉杆',
    turnIn: ['哦！这条鱼可真精神喵！图鉴已经帮你登记上了。', '接下来去抓一只虫子来吧——任务详情到服务处找皮卡丘确认喵！'],
    rewardMiles: 800,
  },
  {
    id: 'bug', title: '抓 1 只虫给喵喵', need: 1,
    hint: '装备虫网，靠近蝴蝶按 E',
    turnIn: ['漂亮的虫子！你对生物很有研究的天赋喵。', '对了，这个「铲子」给你，挖星形痕迹会有好东西喵！下一个目标到服务处找皮卡丘确认吧喵！'],
  ...
  },
  {
    ...
    turnIn: ['5,000 积分，一分不少！移居套餐的费用全部结清了喵！', '按照约定，你的帐篷现在就可以改建成房子了——施工开始！……好了！恭喜乔迁新居喵！', '对了，新的目标发布在服务处了喵——广场北边的博物馆也有新动作，去找向导皮卡丘看看吧！'],
    rewardMiles: 0,
  },
  {
    id: 'museum', title: '给博物馆捐赠 3 件展品', need: 3,
    hint: '进入博物馆找傅达，捐赠虫、鱼或化石',
    turnIn: ['3 件展品！傅达高兴得翅膀都拍起来了喵。博物馆因为你变得越来越像样了！', '接下来试试做生意吧——具体目标到服务处找皮卡丘确认喵！'],
    rewardMiles: 1000,
  },
  {
    id: 'earn', title: '卖东西累计赚 3000 金币', need: 3000,
    hint: '树果、鱼、虫、化石都能卖给友好商店',
    turnIn: ['3,000 金币！你很有做生意的天赋喵！', '赚了钱也要懂得装点生活喵——下一个目标到服务处找皮卡丘确认吧喵！'],
    rewardMiles: 1000,
  },
  {
    id: 'plant', title: '种下 3 株植物', need: 3,
    hint: '把树苗或花种拿在手上，对草地按 E 种植',
    turnIn: ['小岛变得越来越漂亮了喵！', '住在岛上，和伙伴们的感情也很重要——下一个目标到服务处找皮卡丘确认吧喵！'],
    rewardMiles: 800,
  },
  {
  ...
  },
  {
    ...
    hint: '卖东西攒金币，找喵喵还款',
    turnIn: ['49,800 金币，全部结清喵！', '扩建工程——开工！……完成！看看你的新家，是不是宽敞多了喵！', '对了喵，看你这么能干，我有个大胆的提议——要不要在岛上开一家属于自己的店？开店的目标发布在服务处，去找皮卡丘看看详情喵！'],
